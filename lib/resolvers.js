...
function findBlogEntries(page) {
  ...
  if (noBamboozle(blogEntriesDir) && noBamboozle(blogEntryName)){
    blogEntries = fs.readdirSync(path.resolve(__dirname, DATA, blogEntriesDir)).reverse()
  } else {return []}
...
function pageInfo(page){
  ...
  if (noBamboozle(page.entriesDir)){
    blogEntries = fs.readdirSync(path.resolve(__dirname, DATA, page.entriesDir)).reverse()
  } else {return []}
